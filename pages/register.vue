    ...
    <div class="min-h-screen bg-orange-400 flex justify-center items-center">
      ...
      <div class="py-12 px-12 bg-white rounded-2xl shadow-xl z-20">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
                ...
                <input v-model="formData.prenom" type="prenom"  placeholder="prenom" class="block text-sm py-3 px-4 rounded-lg w-full border outline-none" required>
                <input v-model="formData.nom" type="Nom"  placeholder="Nom" class="block text-sm py-3 px-4 rounded-lg w-full border outline-none" required>
                ...
                <div class="text-center mt-6">
                     ...
                     <NuxtLink to="/login" class="n-link-base">
                      login
                      </NuxtLink>
                    </p>
                </div>
